...
Jest to projekt, w którym przeanalizowałem dane dużego sklepu internetowego. Skupiłem się na tym, żeby wyciągnąć konkretne wnioski o zyskach i stratach, a nie tylko wypisać tabelki.
...
Rankingi: Wyciągnąłem topowych klientów i sprawdziłem, który stan radzi sobie najlepiej.

**Kilka wniosków z danych:**
Nowy Jork to lider: Mimo mniejszej liczby zamówień niż w Kalifornii, średnia wartość koszyka jest tam wyższa.
